...
int main()
{
    ...
    while(!enemies->empty())
    {
        ...
        std::cout << "Duelo " << current_enemy_index + 1 << std::endl;
 
        int current_round = 0;
        while(enemy.health > 0 && mechon.health > 0)
        {
            current_round++;
            std::cout << "Ronda " << current_round << std::endl;

            // -> ataque mechon a enemigo
            std::cout << "Mechon ataca con " << mechon.damage << " a enemigo, "; 
            ...
            {
                std::cout << "Enemigo especial se divide en 2" << std::endl;
                Enemy new_enemy_a;
            ...
            std::cout << "(Daño acumulado : " << total_damage_to_enemies << ")" << std::endl;
        }
        ...
        if(mechon.health <= 0)
        {
            std::cout << "Mechón derrotado" << std::endl;
            break;
        }
